...
class FinaliseWithoutRouter extends Component {
  state = {
    birthDay: '',
    title: '',
    organisation: '',
  ...
  componentWillReceiveProps(nextProps) {
    const { applicationCompleteError } = nextProps

    if (applicationCompleteError) {
      provideFeedback(this, applicationCompleteError)
  ...
  onSubmit = () => {
    ...
    const { email, finalise } = this.props
  ...
  render() {
    ...
    return (
      <div className="content">
        <h4>Finalise Leaderal application</h4>
...
export const Finalise = withRouter(FinaliseWithoutRouter)
