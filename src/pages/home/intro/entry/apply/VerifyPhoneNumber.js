...
class VerifyPhoneNumberWithoutRouter extends Component {
  state = {
    code: '',
    newPhoneNumber: '',
  ...
  onSubmit = () => {
    ...
    const { email, verifyPhoneNumber } = this.props

    if (code) {
      this.setState({ loading: true })
      verifyPhoneNumber(email, code)
    } else {
      provideFeedback(
        this,
...
export const VerifyPhoneNumber = withRouter(VerifyPhoneNumberWithoutRouter)
