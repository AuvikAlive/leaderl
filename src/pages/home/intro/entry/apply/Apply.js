...
class ApplyWithoutRouter extends Component {
  state = {
    firstName: '',
    lastName: '',
    email: '',
  ...
  componentWillReceiveProps(nextProps) {
    const { applicationError } = nextProps

    if (applicationError) {
      provideFeedback(this, applicationError)
  ...
  onSubmit = () => {
    ...
    if (
      ...
      this.props.apply({ firstName, lastName, email, phoneNumber })
    } else {
...
export const Apply = withRouter(ApplyWithoutRouter)
